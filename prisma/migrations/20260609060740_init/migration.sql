...
CREATE TABLE "Coffee" (
    ...
    "brewTemp" INTEGER,
    "brewRatio" TEXT,
    "doseG" DOUBLE PRECISION,
    "waterMl" INTEGER,
    "notes" TEXT,
    "scoreAcidity" INTEGER,
    "scoreSweetness" INTEGER,
    "scoreBitterness" INTEGER,
    "scoreBody" INTEGER,
    "scoreAftertaste" INTEGER,
...
-- CreateIndex
CREATE INDEX "Coffee_userId_createdAt_idx" ON "Coffee"("userId", "createdAt");
